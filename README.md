...
==========================================  <br>
The inferred network topology is generated by BoolFunc-GA. The output format displays the predicted regulatory genes associated with each target gene, as follows:
